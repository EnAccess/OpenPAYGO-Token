...
if __name__ == '__main__':
    ...
    device_simulator = DeviceSimulator(device_starting_code, device_key, restricted_digit_set=restricted_digit_set)
    print('Server: We initiate the server simulator with our device')
    server_simulator = SingleDeviceServerSimulator(device_starting_code, device_key, restricted_digit_set=restricted_digit_set)
