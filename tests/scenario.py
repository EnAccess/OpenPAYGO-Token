from openpaygo import OPAYGOShared
...
if __name__ == '__main__':
    ...
    print('\n')
    print('##### Test Add 1 Day #####')
    print('Server: We add 1 days of activation for the device')
    now = datetime.now()  # Ensure the datetime.now is the same for assertion
    ...
    assert_time_equals(device_simulator.expiration_date,
                       now + timedelta(days=1))

    print('\n')
    print('##### Test Repeat Token #####')
    ...
    print('\n')
    print('##### Test Token Out of Sequence #####')
    print('Server: We add generate 6 tokens each add-time of 1 day')
    token_1 = server_simulator._generate_token_from_value(
        1, OPAYGOShared.TOKEN_TYPE_ADD_TIME)
    token_2 = server_simulator._generate_token_from_value(
        1, OPAYGOShared.TOKEN_TYPE_ADD_TIME)
    token_3 = server_simulator._generate_token_from_value(
        1, OPAYGOShared.TOKEN_TYPE_ADD_TIME)
    token_4 = server_simulator._generate_token_from_value(
        1, OPAYGOShared.TOKEN_TYPE_ADD_TIME)
    token_5 = server_simulator._generate_token_from_value(
        1, OPAYGOShared.TOKEN_TYPE_ADD_TIME)
    token_6 = server_simulator._generate_token_from_value(
        1, OPAYGOShared.TOKEN_TYPE_ADD_TIME)
    ...
    print(
        'Device: We check the device status (should be active with +1 day (2 days total)')
    device_simulator.print_status()
    assert device_simulator.count == server_simulator.count
    assert_time_equals(device_simulator.expiration_date,
    ...
    print('\n')
    print('##### Test Add and Set Out of Sequence #####')
    print('Server: We add generate 2 tokens, first add-time and then set-time')
    token_1 = server_simulator._generate_token_from_value(
        1, OPAYGOShared.TOKEN_TYPE_ADD_TIME)
    token_2 = server_simulator._generate_token_from_value(
        0, OPAYGOShared.TOKEN_TYPE_SET_TIME)
    ...
    print('\n')
    print('##### Test Add and Set Out of Sequence #####')
    print('Server: We add generate 2 tokens, first set-time and then add-time')
    token_1 = server_simulator._generate_token_from_value(
        1, OPAYGOShared.TOKEN_TYPE_SET_TIME)
    token_2 = server_simulator._generate_token_from_value(
        1, OPAYGOShared.TOKEN_TYPE_ADD_TIME)
    print('Tokens: ', token_1, token_2)
    print('Device: We enter the 2nd token')
