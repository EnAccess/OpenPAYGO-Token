...
from validation_test.helpers import ADD_TIME, SET_TIME, DISABLE_VALUE, generate_from_device_data, test_accepted, test_how_many_days, test_name
...
def run_unordered_entry_tests(device_data):
    ...
    test_how_many_days('U3B', token_u3a, None)
